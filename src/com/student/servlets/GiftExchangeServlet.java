...
@WebServlet("/GiftExchangeServlet")
public class GiftExchangeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public GiftExchangeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("StuMainView/giftExchange.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
